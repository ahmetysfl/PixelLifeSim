# Parameters
FIXED_STEP_DURATION = 0  # Each step is 0.2 seconds
MAX_CREATURES = 300
# Ölen yaratıkların maksimum sayısı
MAX_DEAD_CREATURES = 100  # Ölen yaratıkların saklanacağı maksimum sayı

MAX_ENERGY_CAPACITY = 200
MIN_ENERGY_CAPACITY = 1
GENERAL_ENERGY_CONSUMPTION = 10
GENERAL_ENERGY_PRODUCTION = 6
